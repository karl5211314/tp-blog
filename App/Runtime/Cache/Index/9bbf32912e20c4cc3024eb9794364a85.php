...
<!--头部-->
	...
	<div class='top-nav-wrap'>
		<ul class='nav-lv1'>
			...
			<?php
 $_nav_cate = M('cate')->order("sort ASC")->limit(30)->select(); import('Class.Category', APP_PATH); $_nav_cate = Category::unlimitedForLayer($_nav_cate); foreach ($_nav_cate as $_nav_cate_v) : extract($_nav_cate_v); $url = U('/c_' . $id); ?><li class='nav-lv1-li'>
	...
	<div class='main'>
		<div class='main-left'>
			<div class='location'>
				...
				<?php if(is_array($parent)): foreach($parent as $key=>$v): ?><!-- <?php echo $key; ?> -->
		...
		<div class='main-right'>
			...
			<dl>
				<dt>热门博文</dt>
				<?php $field = array("id", "title", "click");$_hot_blog = M("blog")->field($field)->limit(5)->order("click DESC")->select();foreach ($_hot_blog as $_hot_value):extract($_hot_value);$url = U("/" . $id);?><dd>
